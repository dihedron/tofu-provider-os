...
ifdef _APPLICATION_PLUGIN_ADDRESS
	_GORELEASER_MK_VARS_PLUGIN_ADDRESS ?= $(_APPLICATION_PLUGIN_ADDRESS)
endif
...
_GORELEASER_MK_VARS_PLUGIN_ADDRESS ?= github.com/<your-github-username>/${_GORELEASER_MK_VARS_NAME}
...
goreleaser-snapshot: ## snapshot build using goreleaser
	...
	_GORELEASER_MK_VARS_PLUGIN_ADDRESS="${_GORELEASER_MK_VARS_PLUGIN_ADDRESS}" \
